-- Fix Product Analytics Functions Conflict
-- Run this in Supabase SQL Editor

-- Drop any existing functions that might conflict
DROP FUNCTION IF EXISTS aggregate_product_revenue(start_date DATE, end_date DATE);
DROP FUNCTION IF EXISTS aggregate_product_revenue(start_date TIMESTAMP, end_date TIMESTAMP);
DROP FUNCTION IF EXISTS aggregate_ad_spend_by_campaign(start_date DATE, end_date DATE);
DROP FUNCTION IF EXISTS aggregate_ad_spend_by_campaign(start_date TIMESTAMP, end_date TIMESTAMP);
